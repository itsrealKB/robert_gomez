                ...
                <div class="container-fluid">
                    <div class="dashboard-content">
                        ...
                        <div class="category-btn-wrapper">
                            <button type="button" class="cat-btn">Search appraiser</button>
                            <button type="button" class="cat-btn" id="addRowBtn">add new appraiser</button>
                    ...
                    <form id="addCategoryForm">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="date" class="form-control" name="DateofCreation" required>
                            </div>
                            <div class="col-lg-6 mb-3">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#addCategoryForm').on('submit', function (e) {
                ...
                const DateofCreation = $('input[name="DateofCreation"]').val();
                ...
                const Active = $('select[name="Active"]').val();
            ...
            $(document).on('click', '.action-toggle', function () {
                ...
                $actionMenu.on('click', '.edit-item', function () {
                    ...
                    $('input[name="DateofCreation"]').val(cells.eq(1).text());
                    $('input[name="FirstName"]').val(cells.eq(2).text());
                    $('input[name="LastName"]').val(cells.eq(3).text());
                    $('input[name="State"]').val(cells.eq(4).text());
                    $('input[name="email"]').val(cells.eq(5).text());
                    $('input[name="email"]').val(cells.eq(6).text());
                    $('input[name="phone"]').val(cells.eq(7).text());
                    $('select[name="Username"]').val(cells.eq(8).text());
                    $('select[name="active"]').val(cells.eq(9).text());
