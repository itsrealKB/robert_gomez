            ...
            <section class="content" style="min-height: 100vh;">
                <div class="container-fluid">
                    <div class="dashboard-content">
                        <h1 class="dashboard-hd">Insurance Adjusters</h1>
                        <div class="category-btn-wrapper">
                            <button type="button" class="cat-btn" id="addRowBtn">add new adjustors</button>
                    ...
                    <form id="addCategoryForm">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="Insurance" required>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label>Status</label>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#addCategoryForm').on('submit', function (e) {
                ...
                const insurance = $('input[name="email"]').val();
            ...
            $(document).on('click', '.action-toggle', function () {
                ...
                $actionMenu.on('click', '.edit-item', function () {
                    ...
                    $('input[name="Firstname"]').val(cells.eq(1).text());
                    $('input[name="Lastname"]').val(cells.eq(2).text());
                    $('input[name="email"]').val(cells.eq(3).text());
                    $('input[name="phone"]').val(cells.eq(4).text());
                    $('input[name="email"]').val(cells.eq(5).text());
                    $('select[name="status"]').val(cells.eq(6).text());
