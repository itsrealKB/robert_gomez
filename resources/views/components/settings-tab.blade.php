<div class="inner-head-wrap3">
    <ul class="inner-head3 justify-content-between">
        ...
        <a href="{{ route('admin.settings.guidelines') }}" class="link text-decoration-none">
            <li class="inner-list inner-list-1">Assignment Guidelines</li>
        </a>
        <a href="{{ route('admin.settings.client.forms') }}" class="link text-decoration-none">
            <li class="inner-list inner-list-1">Client Forms</li>
        </a>
        <a href="{{ route('admin.settings.general.forms') }}" class="link text-decoration-none">
            <li class="inner-list inner-list-1">General Forms</li>
        </a>
        {{-- <a href="#" class="link text-decoration-none">
